...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('customers', '0003_alter_shippingaddress_options'),
    ]

    operations = [
        migrations.RemoveField(
            model_name='customer',
            name='alternative_number_phone',
        ),
        migrations.AddField(
